...
public class Cartao_de_credito {
	...
	public static void setContador(int contador) {
		Cartao_de_credito.contador = contador;
	}
	...
	public String toString() {
		return "Cartao_de_credito [numero_cartao=" + numero_cartao + ", data_validade_cartao=" + data_validade_cartao
				+ "]";
	}
